...
const User = ({match}) => {
  ...
  const { name, location, blog, bio, company, html_url, followers, following, login, avatar_url, public_repos, public_gist, hireable} = user;
  ...
  return <Fragment>
    ...
    <div className='card text-center'>
      ...
      <div className='badge badge-dark'>Public Gits: {public_gist}</div>
    </div>
    <Repos repos={repos} />
  </Fragment>;
